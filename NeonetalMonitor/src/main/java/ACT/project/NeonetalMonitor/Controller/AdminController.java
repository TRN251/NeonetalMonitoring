...
import ACT.project.NeonetalMonitor.Service.AppointmentServiceImplementation;
...
public class AdminController {
	...
	public String showFormForAdd1(Model theModel) {
		...
		theModel.addAttribute("Nurse", admin);
	...
	public String saveNurse(@ModelAttribute("Nurse") Admin admin) {

		// save the employee
		//	admin.setId(0);

		admin.setRole("ROLE_NURSE");
